...
const Navbar = () => {
  ...
  return (
    <div className='rounded-div flex items-center justify-between h-20 font-bold'>
        ...
        {/* Mobile Menu */}
        <div className={nav ? 'md:hidden fixed left-0 top-20 flex flex-col items-center justify-between w-full h-[85%] bg-primary ease-in duration-300 z-10'
            ...
            <div className='flex flex-col w-full p-4'>
                ...
                <Link to='/signup'>
                    <button onClick={handleNav} className='w-full p-3 bg-button text-btnText rounded-2xl shadow-xl'>Sign Up</button>
                </Link>
            </div>

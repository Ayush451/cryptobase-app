...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary'>
        <div className='grid md:grid-cols-2'>
            ...
            <div className='text-right'>
                <div className='w-full flex justify-end'>
                    <div className='w-full md:w-[300] py-4 relative'>
                        ...
                        <div className='py-4'>
                            <form>
                                <input className='bg-primay border border-input p-2 mr-3 w-full shadow-xl rounded-2xl md:w-auto' type="email" placeholder='Enter your email'/>
        ...
        <p className='text-center py-4'>Created by Ayush</p>
    </div>
  )
}
